...
Begin VB.Form BinderMainForm 
   ...
   Caption         =   "Odesa Yazýlým Exe Joiner - www.odesayazilim.com"
   ClientHeight    =   2100
   ClientLeft      =   150
   ClientTop       =   540
   ClientWidth     =   7860
   Icon            =   "BinderForm.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   2100
   ScaleWidth      =   7860
...
' Odesa Exe joiner
' version 1.0
' Author: Alper ESKIKILIC
'
'
' web  : www.odesayazilim.com
' email: odesayazilim@gmail.com
' Blog : odesateknikservis.blogspot.com
'************************************************************
